...
def build_out_subparsers(subparser_hook):
    ...
    This command will dynamically search all subpackages of `daybook.cli`,
    ...
    Returns:
        None
    """
    parser_modules = [importlib.import_module(f'daybook.client.cli.{x}.parser') for x in get_subcommands(_pkg_root)]
    parser_builders = []
