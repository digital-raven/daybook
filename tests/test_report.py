...
class TestReport(unittest.TestCase):
    ...
    def test_import_reporter(self):
        ...
        """
        _, _, report, _ = import_reporter(f'{resources}/report.py')
    ...
    def test_import_reporter_doesnt_exist(self):
        ...
        with self.assertRaises(OSError):
            _, _, _, _ = import_reporter(f'{resources}/doesnt_exist.py')

    def test_import_reporter_missing_report(self):
        """ report function should be present.
        """
        with self.assertRaises(KeyError):
            _, _, _, _ = import_reporter(f'{resources}/bad_report_missing_report.py')
